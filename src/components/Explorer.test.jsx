...
describe("successful data fetching", () => {
    ...
    test("shows top-level contents", async () => {
        ...
        expect(await screen.findByRole("row", { name: /folder\// })).toBeInTheDocument();
    });
    ...
    test("filters contents matching exclude pattern", async () => {
        ...
        expect(screen.queryByRole("row", { name: /index\.html/ })).not.toBeInTheDocument();
    });
    ...
    test("can navigate through contents", async () => {
        ...
        expect(await screen.findByRole("row", { name: /file\.txt/ })).toBeInTheDocument();
...
describe("failed data fetching", () => {
    ...
    test("shows error message", async () => {
        ...
        expect(await screen.findByRole("row", { name: "Failed to fetch data: Error" })).toBeInTheDocument();
    });
});
